...
DESCRIPTION = "法务合同管理：合同台账、审批、用印与履约提醒"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="法务部", min_length=1, max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "法务部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
