#!/bin/bash
# =============================================================================
# 恢复脚本 - sm-legal-contract
# -----------------------------------------------------------------------------
# 功能：从指定的 .sql.gz 备份文件恢复 PostgreSQL 数据库
#
# 使用：
#   chmod +x scripts/restore.sh
#   ./scripts/restore.sh /backup/sm-legal-contract/20260916_020000.sql.gz
#   ./scripts/restore.sh -f /backup/sm-legal-contract/20260916_020000.sql.gz   # 非交互，跳过确认
#
# 环境变量：
...
DB_NAME="${DB_NAME:-sm_legal_contract_db}"
